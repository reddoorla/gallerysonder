import { U as head, V as attr, W as attr_class, X as stringify, Y as clsx, Z as attr_style, _ as attributes, $ as ensure_array_like, a0 as store_get, a1 as unsubscribe_stores, a2 as bind_props, a3 as slot } from "../../chunks/index2.js";
  ...
  $$renderer.component(($$renderer2) => {
    ...
    if (appState.isNewsletterActive) {
      ...
      ContentWidth($$renderer2, {
        ...
        children: ($$renderer3) => {
          $$renderer3.push(`<button class="absolute top-12 left-0 hover:opacity-80" aria-label="Close newsletter signup"><i class="text-black fa-sharp fa-light fa-close fa-2xl hover:opacity-80 transition"></i></button> <a href="/" class="absolute top-5 right-0 hover:opacity-80">`);
          RotatingLogo($$renderer3, { class: "h-6" });
          $$renderer3.push(`<!----></a> `);
          if (!submitted) {
            $$renderer3.push("<!--[-->");
            ...
            $$renderer3.push(`<!----></div> <p class="text-xs mt-24">By signing up, you agree to the Terms of Use and Privacy Policy to receive electronic <br/> communications from Gallery Sonder. You can unsubscribe or change your preferences at any time.</p>`);
          } else {
            $$renderer3.push("<!--[!-->");
            if (error) {
              $$renderer3.push("<!--[-->");
  ...
  $$renderer.component(($$renderer2) => {
    ...
    if (appState.isLightboxActive && appState.activeArtworkUid) {
      ...
      ContentWidth($$renderer2, {
        ...
        children: ($$renderer3) => {
          $$renderer3.push(`<button class="h-6" aria-label="Close modal"><i class="text-black fa-sharp fa-light fa-close fa-2xl hover:opacity-80 transition"></i></button> <a href="/">`);
      ...
      ContentWidth($$renderer2, {
        ...
        children: ($$renderer3) => {
          if (!appState.activeArtwork) {
            $$renderer3.push("<!--[-->");
            $$renderer3.push(`<div class="w-full h-full flex items-center justify-center"><i class="fa-regular fa-circle-notch fa-spin fa-2xl text-black/80"></i></div>`);
          } else {
            $$renderer3.push("<!--[!-->");
            ...
            if (appState.showInquiryForm) {
              ...
              if (!submitted) {
                ...
                $$renderer3.push(`<!----> <div class="text-xs mt-12 mb-24">By signing up, you agree to the Terms of Use and Privacy Policy to receive
									electronic communications from Gallery Sonder. You can unsubscribe or change your
									preferences at any time.</div></div>`);
              } else {
                $$renderer3.push("<!--[!-->");
                if (error) {
                  $$renderer3.push("<!--[-->");
                  $$renderer3.push(`<h2>We're sorry, there appears to be an error. Please email info@gallerysonder.com with
								your inquiry.</h2>`);
                } else {
                  $$renderer3.push("<!--[!-->");
...
function _layout($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    if (!appState.isIntroRunning && navDelayDone) {
      $$renderer2.push("<!--[-->");
      Nav($$renderer2, { navProps: data.nav.data.links });
    } else {
      $$renderer2.push("<!--[!-->");
    }
    $$renderer2.push(`<!--]--> <!--[-->`);

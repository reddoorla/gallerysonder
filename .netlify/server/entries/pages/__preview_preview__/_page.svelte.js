import { b as attr_class, l as bind_props, c as stringify, s as sanitize_props, m as slot, f as attr_style, e as store_get, u as unsubscribe_stores, a as attr } from "../../../chunks/index2.js";
...
import { V as ssr_context, T as escape_html } from "../../../chunks/context.js";
import "clsx";
...
function VimeoPlayer_1($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    let muted = fallback($$props["muted"], true);
    let loop = fallback($$props["loop"], false);
    let background = fallback($$props["background"], true);
    let isPlaying = fallback($$props["isPlaying"], false);
    let player;
    onDestroy(() => {
    });
    const play = async () => {
...
function Intro($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    function $$render_inner($$renderer3) {
      ...
      $$renderer3.push(`<!----></div> <div${attr_class(`bg-black ${stringify("opacity-0")} w-full h-full absolute left-0 -z-20 top-0`, "svelte-10cvnim")}></div> <div${attr_class(`bg-black ${stringify("opacity-20")} w-full h-full absolute left-0 top-0 transition-opacity duration-1000`, "svelte-10cvnim")}></div></div> `);
      if (!store_get($$store_subs ??= {}, "$isIntroRunning", isIntroRunning) && isVideoDone) {
        $$renderer3.push("<!--[-->");

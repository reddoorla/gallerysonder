import { a as attr, e as store_get, u as unsubscribe_stores, f as attr_style, c as stringify, l as bind_props, b as attr_class, k as ensure_array_like } from "./index2.js";
import { C as ContentWidth } from "./PrismicRichText.js";
import { b as backgroundColor, L as LinkArrowButton, h as hasNewsletterBeenCleared, i as isNewsletterActive } from "./lightbox.js";
...
function InnerPageNav($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    let slicesSections = $$props["slicesSections"];
    ...
    $$renderer2.push(`<!----></div>`);
    bind_props($$props, { sections, slicesSections });
  });
}
export {
  Footer as F,

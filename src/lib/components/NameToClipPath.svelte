...
<a class="relative w-fit {$$props.class || ''}" 
...
>
    ...
    src={activeImage}
    alt="sonder logo"
    class="absolute top-0 left-0 translate-x-[1.05%] scale-[1.02] transition-opacity duration-500 {hovered ? "opacity-1" : "opacity-0"} {$$props.class || ''}"

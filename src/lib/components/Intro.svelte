...
<div class="w-screen h-screen fixed top-0 left-0 bg-black" transition:fade>
	...
	<!-- Video Player -->
	<div
		class="w-screen h-screen absolute top-0 left-0 -z-10 transition-opacity"
	...
	<!-- Background Overlays -->
	<div
		class="bg-black {isVideoDone ? 'opacity-0' : ''} w-full h-full absolute left-0 -z-20 top-0"
	></div>
	<div
